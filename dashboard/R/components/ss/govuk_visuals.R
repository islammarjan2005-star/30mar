...
#' }
#'
#' # ========== PERCENT: HEADLINE vs DELTA (unsigned) ==========
#'
#' #' Percent (values already on 0–100), 1 decimal place – for HEADLINES
#' #' e.g. 12.3 -> "12.3%"
#' #'
...
#' }
#'
#' #' Percent (proportions 0–1) -> 0–100, 1 dp – for HEADLINES
#' #' e.g. 0.123 -> "12.3%"
#' #'
...
#' }
#'
#' #' Percent (values already on 0–100), 1 dp – for DELTAS (NO SIGN)
#' #' Uses absolute value so your own sign/colour logic controls the tag.
#' #'
#' #' @param x Numeric vector (percent values 0–100).
...
#' }
#'
#' #' Percent (proportions 0–1), 1 dp – for DELTAS (NO SIGN)
#' #'
#' #' @param x Numeric vector as proportions (0–1).
...
#'
#' #' Millions formatter rounded to nearest 10,000 (0.01m steps) – HEADLINES
...
#'
#' #' GBP currency (≤ 2 dp, strip trailing zeros), with comma separators – HEADLINES
...
#' }
#'
#' #' GBP currency (≤ 2 dp, strip trailing zeros) – DELTAS (NO SIGN)
#' #' Always formats absolute values, leaving sign/colour to the tag logic.
#' #'
#' #' @param x Numeric vector.
