...
wip_ui <- function(id) {
  ...
  #Left Nav TOC list and sections list----
  toc_items <- list(
...
#===== Overview =====
                  div(class = "govuk-grid-row",
                    ...
                    tags$h1(class = "govuk-heading-xl", "Average Weekly Earnings"), 
...
#===== Section A =====
                  div(class = "govuk-grid-row",
                    ...
                    tags$h1(class = "govuk-heading-xl", "Employment Status"),  
...
#===== Section C =====
                  div(class = "govuk-grid-row",
                    ...
                    employment_awe_stats_card_ui(ns("awe_card_4"))
                    )))
)))
}
...
wip_server <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    employment_awe_stats_card_server("awe_card_4")
  })
}
...
#                                        employment_awe_stats_card_ui(ns("awe_stats_card"))
# 
#                           ),
#                           
